# local-project-integrity Specification

## Purpose

Define failure-atomicity, containment, and concurrency requirements for
filesystem lifecycle operations and local project mutations.
